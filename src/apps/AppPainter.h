...
class AppPainter : public App
{
  private:
    ...
    static inline std::array<glm::mat4x4, ColorSpace::ColorSpaceSize> _tranformMatrixFromRygb = {
        //glm::mat4x4{
        //    {0.7792032424976721, -0.07345654740649143, -0.012701296161286168, 0.0},
        //    {0.9091700123392266, 0.2842109603453271, -0.053993996192361504, 0.0},
        //    {-0.3752613463957606, 0.8628592868784778, 0.0315940614671974, 0.0},
        //    {0.04545921167637455, -0.07311962107157864, 1.0317769071831495, 0.0},
        //},
        glm::mat4x4{
            {0.6503689928274792, 0.020929352450840138, -0.14666034877306292, 0.0},
            {-0.03719538107673851, 0.0684398857073309, 1.0555205867155852, 0.0},
            {-0.021410033167420742, 0.7948044426130713, 0.09896544106682162, 0.0},
            {0.002661117591768238, 0.008299733578906154, -0.007825679009327383, 0.0},
        },
        glm::mat4x4{
            {-0.002479705799319937, 0.020929352450840138, -0.14666034877306292, 0.0},
            {-0.00674677296488404, 0.0684398857073309, 1.0555205867155852, 0.0},
            {0.0049511362173833996, 0.7948044426130713, 0.09896544106682162, 0.0},
            {0.5129464764084428, 0.008299733578906154, -0.007825679009327383, 0.0},
        },
        //glm::mat4x4{
